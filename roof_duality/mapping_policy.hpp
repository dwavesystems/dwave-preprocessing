...
// PLEASE DO NOT MAKE AN INTERFACE FOR THE MAPPER CLASS. VIRTUAL DISPATCH WILL ADD
// TO THE ALREADY EXISTING PENALTY OF USING THIS METHODOLOGY. WE CREATED THIS
// CLASS SINCE WE CAN HAVE PERFORMANCE ADVANTAGE WITH ALTERNATE/EVEN_ODD MAPPING WHILE IT
...
// changed. If there are n variables in the Quobo, the posiform will have 2 * ( n + 1 )
